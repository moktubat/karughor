    ...
    return (
        <div className="border-b border-[#E4E9EE] last:border-b-0">
            ...
            >
                ...
                <MdKeyboardArrowDown
                    className={`w-6 h-6 text-[#818B9C] shrink-0 transition-transform duration-300 ease-in-out ${open ? 'rotate-180' : ''
                        }`}
                />
            </button>

            {/* ✨ Smooth CSS-only animation */}
            <div
                className={`grid transition-all duration-500 ease-in-out ${open ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'
                    }`}
            >
                <div className="overflow-hidden">
                    <p className="text-[#818B9C] text-base leading-relaxed pb-5 -mt-1 transform transition-all duration-500 ${
        ...
        <div className="bg-white w-full min-h-screen py-12 px-4">
            <div className="max-w-300 mx-auto">
                ...
                <div className="mt-14 bg-[#FFF5F2] border border-[#C85A3A]/20 rounded-xl p-8 text-center">
                    <h3 className="text-xl font-semibold text-[#0B0F0E] mb-2">
                        Still have questions?
                    </h3>

                    <p className="text-[#818B9C] mb-6">
